...
func Eval(node ast.Node, env *object.Environment) object.Object {
	//fmt.Printf("evaluating (%T) node: %v\n", node, node)
...
func evalInfixExpression(operator string, left, right object.Object) object.Object {
	...
	case operator == "==":
		// we can compare pointers direcly here because all bools are pointers
		// to TRUE or FALSE "constants"
...
func evalStringInfixExpression(operator string, left, right object.Object) object.Object {
	...
	case "==":
		return nativeBooltoBooleanObject(slices.Equal([]byte(leftVal), []byte(rightVal)))
	case "!=":
		return nativeBooltoBooleanObject(!slices.Equal([]byte(leftVal), []byte(rightVal)))
	default:
