...
const GlobalsSize = 65536 // u16 limited
...
func (vm *VM) Run() error {
	...
	for vm.currentFrame().ip < len(vm.currentFrame().Instructions())-1 {
		...
		case code.OpReturnValue:
			...
			frame := vm.popFrame()
			vm.sp = frame.basePointer - 1 // restore stack pointer after a function call
...
func (vm *VM) executeBinaryOperation(op code.Opcode) error {
	...
	default:
		return fmt.Errorf("unsupport types for binary operation: %s %s",
			leftType, rightType)
	}
